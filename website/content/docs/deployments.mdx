...
three enforcers Hourglass delegations reference were deployed 2026-06-25 and the rest
of the suite on 2026-07-25. On Base, all 37 were deployed 2026-07-25.
...
These three are the ones the app actually routes through — a subscription cap, its
optional end date, and the payroll stream.

| Contract | Address |
|---|---|
| `ERC20PeriodTransferEnforcer` | `0x11262E3116a50654547AB0A417BE77eB14b9F339` |
| `TimestampEnforcer` | `0xF1635460548F44543366ec4453D512a7Ce85Af85` |
| `ERC20StreamingEnforcer` | `0xE475D14d61756D6e940B74C20d2E44EB70c71a8D` |
